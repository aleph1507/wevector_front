...
class ContentTableSeeder extends Seeder
{
    ...
    public function run()
    {
      $content = [
        ...
        ['text', 'landing', 's2b', 'how it works', null, null],
        ['link', 'landing', 's2burl', 'http://www.wevector.com/howitworks', null, null],
        ['text', 'landing', 'shows2b', 'true', null, null],
        ['text', 'landing', 's1bgcolor', '#15053a', null, null],
        ['text', 'landing', 's2bgcolor', '#464646', null, null],
        ['text', 'landing', 's3bgcolor', '#a9d7d5', null, null],
        ['text', 'landing', 's4bgcolor', '#fddfdf', null, null],
        ['text', 'landing', 's5bgcolor', '#ffffff', null, null],
        ['text', 'landing', 's6bgcolor', '#15053a', null, null],
        ['text', 'landing', 's1fontcolor', '#ffffff', null, null],
        ['text', 'landing', 's2fontcolor', '#ffffff', null, null],
        ['text', 'landing', 's3fontcolor', '#ffffff', null, null],
        ['text', 'landing', 's4fontcolor', '#000000', null, null],
        ['text', 'landing', 's5fontcolor', '#000000', null, null],
        ['text', 'landing', 's6fontcolor', '#ffffff', null, null],
        ['img', 'landing', 's2ibg', 'group-210.png', null, null],
        ['text', 'landing', 'shows2bgi', 'false', null, null],
        ...
        ['text', 'landing', 's3b', 'see our plans', null, null],
        ['link', 'landing', 's3burl', 'http://www.wevector.com/plans', null, null],
        ['text', 'landing', 'shows3b', 'true', null, null],
        ...
        ['text', 'landing', 's4b', 'hire us', null, null],
        ['link', 'landing', 's4burl', 'http://www.wevector.com/hireus', null, null],
        ['text', 'landing', 'shows4b', 'true', null, null],
        ...
        ['text', 'landing', 's5b', 'hire us', null, null],
        ['link', 'landing', 's5burl', 'http://www.wevector.com/hireus', null, null],
        ['text', 'landing', 'shows5b', 'true', null, null],
        ...
        ['text', 'packages', 'p3title', 'BASIC', null, null],
        ['text', 'packages', 'p3price', '10', null, null],
        ...
        ['text', 'contact', 'contactTitle', 'Managing Director', null, null],
