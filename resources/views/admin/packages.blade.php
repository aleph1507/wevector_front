        ...
        <div class="admin-section">
          <div class="card">
            <div class="card-header">
              <h2>Package: {{$i}} - {{$content->where('placement', 'p' . $i . 'title')->first() != null ? $content->where('placement', 'p' . $i . 'title')->first()->content : ''}}</h2>
            </div>
            <div class="card-body">
              <div class="mt-4">
                <div class="form-group">
                  Title: <input type="text" name="packages-head-title" class="form-control section-title"
                    value="{{$content->where('placement', 'p' . $i . 'title')->first() != null ? $content->where('placement', 'p' . $i . 'title')->first()->content : ''}}"
                ...
                <div class="form-group">
                  Price (in USD): <input type="text" name="landing-page-text" id="packages-page-text" class="form-control"
                    value="{{$content->where('placement', 'p' . $i . 'price')->first() != null ? $content->where('placement', 'p' . $i . 'price')->first()->content : ''}}"
                ...
                <div class="form-group">
                  Timetable: <input type="text" name="landing-page-text" id="packages-page-text" class="form-control"
                    value="{{$content->where('placement', 'p' . $i . 'timetable')->first() != null ? $content->where('placement', 'p' . $i . 'timetable')->first()->content : ''}}"
                ...
                <div class="form-group">
                  Corrections: <input type="text" name="landing-page-text" id="packages-page-text" class="form-control"
                    value="{{$content->where('placement', 'p' . $i . 'corrections')->first() != null ? $content->where('placement', 'p' . $i . 'corrections')->first()->content : ''}}"
                ...
                @if($content->where('placement', 'p' . $i . 'export')->first() !== null)
                  <div class="form-group">
                    Export: <input type="text" name="landing-page-text" id="packages-page-text" class="form-control"
                      value="{{$content->where('placement', 'p' . $i . 'export')->first() != null ? $content->where('placement', 'p' . $i . 'export')->first()->content : ''}}"
                ...
                <div class="form-group">
                  Support: <input type="text" name="landing-page-text" id="packages-page-text" class="form-control"
                    value="{{$content->where('placement', 'p' . $i . 'support')->first() != null ? $content->where('placement', 'p' . $i . 'support')->first()->content : ''}}"
          ...
          <div class="card-body">
            <div class="mt-4">
              ...
              @for($i = 1; $i <= 8; $i++)
                  <div class="form-group">
                    <div class="form-group">
                      Question: <input type="text" name="packages-head-title" class="form-control section-title"
                        value="{{$content->where('placement', 'faqq' . $i)->first() != null ? $content->where('placement', 'faqq' . $i)->first()->content : ''}}"
                    ...
                    <div class="form-group">
                      ...
                      >{{$content->where('placement', 'faqa' . $i)->first() != null ? $content->where('placement', 'faqa' . $i)->first()->content : ''}}</textarea>
                    </div>
                  </div>
              @endfor
