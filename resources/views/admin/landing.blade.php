          ...
          <div class="card-body">
            <div class="mt-4">
              <div class="form-group">
                Title: <input type="text"
                name="landing-head-title" class="form-control section-title"
                data-page="landing" data-placement="s2h"
                value="crafted with care">
              </div>
              <div class="form-group">
                Text: <textarea name="landing-page-text" id="landing-page-text"
                class="form-control" cols="30" rows="5"
                data-page="landing" data-placement="s2p"
              ...
              <div class="upload-btns">
                <div class="row">
                  <div class="col-md-6 col-sm-12">
                    <img src="{{asset('img/section2/Motor.png')}}" class="img-fluid" alt="Motor" id="motor-img-admin">
                  </div>
            ...
            <div class="mt-4">
              <div class="form-group">
                Title: <input type="text" name="landing-head-title" class="form-control section-title"
                        data-page="landing" data-placement="s3h"
                        value="perfect in any format">
              </div>
              <div class="form-group">
                Text: <textarea name="landing-page-text" id="landing-page-text"
                  class="form-control" cols="30" rows="5"
                  data-page="landing" data-placement="s3p"
                  ...
                  <div class="col-md-5 col-sm-12 form-group nlp">
                    <label class="btn btn-lg btn-outline-dark input-btn">
                      <input type="file" class="upload-input"
                        data-page="landing" data-placement="s3i"
                        name="upfile">
                      <i class="fas fa-cloud-upload-alt"></i> Change image
                    </label>
                  </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mt-4">
              <div class="form-group">
                Title: <input type="text" name="landing-head-title" class="form-control section-title"
                data-page="landing" data-placement="s4h"
                value="CUSTOMIZE EVERY DETAIL">
              </div>
              <div class="form-group">
                Text: <textarea name="landing-page-text" id="landing-page-text"
                  class="form-control" cols="30" rows="5"
                  data-page="landing" data-placement="s4p"
              ...
              <div class="upload-btns">
                <div class="row">
                  ...
                  <div class="col-md-5 col-sm-12 form-group nlp">
                    <label class="btn btn-lg btn-outline-dark input-btn">
                      <input type="file" class="upload-input"
                        data-page="landing" data-placement="s4i"
                        name="upfile">
                      <i class="fas fa-cloud-upload-alt"></i> Change image
                    </label>
                  </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mt-4">
              <div class="form-group">
                Title: <input type="text" name="landing-head-title" class="form-control section-title"
                  data-page="landing" data-placement="s5h"
                  value="YOUR DEDICATED TEAM">
              </div>
              <div class="form-group">
                Text: <textarea name="landing-page-text" id="landing-page-text"
                  class="form-control" cols="30" rows="5"
                  data-page="landing" data-placement="s5p"
              ...
              <div class="upload-btns">
                <div class="row">
                  ...
                  <div class="col-md-5 col-sm-12 form-group nlp">
                    <label class="btn btn-lg btn-outline-dark input-btn">
                      <input type="file" class="upload-input"
                        data-page="landing" data-placement="s5i"
                        name="upfile">
                      <i class="fas fa-cloud-upload-alt"></i> Change image
                    </label>
                  </div>
            ...
            <div class="mt-4">
              ...
              <div class="form-group">
                Text: <textarea name="landing-page-text" id="landing-page-text" class="form-control"
                 cols="30" rows="5"
                 data-page="landing" data-placement="s6p"
