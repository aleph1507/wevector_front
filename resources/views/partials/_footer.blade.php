  ...
  <div class="container spaced-top-mod">
    <div class="row section footer" id="footer">
      ...
      <div class="col-12 col-md-6 col-lg-3">
        ...
        <p class="footer-p">
          Would you like to hear more about our service and how we can help you?
          Please get in touch and let’s have a talk about your challenges.<br><br>
          Office +389 2310 7005
          hello@wevector.io
        </p>
      </div>
      <div class="col-12 col-md-6 col-lg-3">
